...
month_calendar = awful.widget.calendar_popup.month({bg = "#00fff0"})
...
awful.screen.connect_for_each_screen(function(s)
    ...
    function custom_shape(cr, width, height)
        gears.shape.transform(gears.shape.rounded_rect):translate(10, 0)(cr,
                                                                         width -
                                                                             20,
                                                                         height -
                                                                             10,
    ...
    s.mywibox:setup{
        {
            ...
            -- Middle widget
            {s.mytasklist, margins = 5, widget = wibox.container.margin},
            {
                {
                    -- Right widgets
                    layout = wibox.layout.fixed.horizontal,
